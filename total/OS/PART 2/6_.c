/*
Program to detect the deadlock in a system.
You might consider using simple data structures like single and two dimensional
arrays to represent your system resources and processes .You are free to input
the number of processes and resources, or use random number generator to
initialize a snapshot of the state of the system.
*/
